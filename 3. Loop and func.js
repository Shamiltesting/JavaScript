...
/*label: for (var i = 1; i <= 10; i++) {
    for (var j = 1; j <= 10; j++) {
        if ( j === 5) {
            console.log("СЛЕДУЮЩАЯ ЦИФРА");
            continue label; //мы видим что благодоря условию "j === 5" и команде "continue label", умножение будет будет происходит пропуская цифру 5   
        }
        console.log(i + " * " + j + " = " + i * j);
    }
    console.log("СЛЕДУЮЩАЯ ЦИФРА")
...
/*label: for (var i = 1; i <= 10; i++) {
    for (var j = 1; j <= 10; j++) {
        if (j === 5) {
            break label; //мы видим что благодоря условию "j === 5" и команде "break label", умножение будет будет происходит только до цифры 5(не включая 5) 
        } 
        console.log(i + " * " + j + " = " + i * j);
    }
    console.log("СЛЕДУЮЩАЯ ЦИФРА");
 ...
 */
 ...
 test(); // данной строкой вызывается функция: пишится ее название и круглые скобочки*/
...
/*function digit() {
    let a = +prompt("Введите цифру");//"prompt" это вызов высплывающего окна с возможностью ввода цифр
...
console.log("\"outside\" = " + outside);
console.log("\"inside\" = " + inside);*///мы видим, что переменная объявленная в функции не будет выводится в не этой функции.

//Есть возможность иницализировать одну и ту же переменную задавая разные значения. В не функции будут одни значения, а внутри функции другие:
...
/*function test() {
    ...
    console.log("Задаем переменной вначале цифру : " + digit);
    var digit; 
    console.log("Несмотря на то, что мы не иницализировали переменную \"digit\", она все равно будет выводить цифру " + digit);
} 
test();*/
...
//Ту же самую функцию можно и подругому написать: 
/*digitOnItSelf();
...
switch (hotelName) {
    ...
    function calculate () {
        let result = (a + a);
        return result// мы убрали с функции объявление/иницалиацию переменной и "console.log", а вместо этого добавили "return", 
    ...
    //Передача аргументво в функцию: 
    /*let a = 5;
    function test(calculate) {//задаем функции аргемнт "calculate" 
    ...
    //Callback функция- передача названия функции в саму функцию, это функция в функции.
