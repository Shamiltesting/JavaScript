...
//Несколько слов о локальных изменениях: 
/*let x = 5;
...
//Цикл может закончится так и не начавшись:
/*while (false) {
    console.log("При false цилк даже не начинает свои итерации");
}
console.log("Конец");*/

//Неограниченное количество итераций в цикле:
/*while (true) {
...
/*let x = 0;
do {
    x += 2;//в каждой итерации будет добавляться 2 
    console.log("Всего интераций будет 3, где к \"x\" будет добавляться 2. А именно \"x\" = " + x);
}
while (x < 5) {
     console.log("По итогу цикла \"x\" = " + x);
     x += 2;//эта строка кода добавляеться еще 2 к конечной цифре, которой равен "x" в конце цикла
 }
...
/*let x = 3;
 ...
 //Можно также делать обратный отчет в цикле:
 /*let j;
 for (i = 4, j = "Hello"; i > 0; j += " +" ) { //можем задавать значение переменной внутри самого цикла, как это сделано с переменной "j"
    ...
    console.log("К слову \"Hello\" будет прибавлятся плюсик в каждом цикле. Смотрим: \"j\"= " + j);
 }
 ...
 /*for (var i = 5; i--;) {
    if (i === 2) {
        console.log("Итераций будет 2. А \"i\" будет равен 2");
        break;
    }
    console.log("\"i\" = " + i);
 } 
...
//А теперь всю таблицу умножения:
...
//В случае, если хотим умножать только парные цифры:
/*for (var i = 1; i <= 10; i++) {
    if(i % 2) 
        continue; 
    for (var j = 1; j <= 10; j++) {
...
/*function digit() {
    ...
    console.log(a * a);// введенная цифра в поле будет умножаться на само себя
 }
 console.log("Функция будет умножать введенную цифру на саму себя")
 digit();*/
