...
console.log("Two hundred and thirty-five " + 0xEB);//чтобы число высчитывало в шестнадцатеричной системе счета используют "0x"
...
console.log(Number.parseInt('11', 2)); // Двоичная система
...
console.log(s);
console.log(s === 0.3);//возвращает false потому что переменная "s"(0.1 + 0.2(0.3)) не равна 0.3  
...
console.log(0.3 === s.toFixed(1));//возвращает false потому что значение "s.toFixed(1)" будет иметь тип значения "string", то есть 0.3 не равно '0.3'
...
/*var str = "ЗДЕСЬ ДОЛЖНО БЫТЬ 20";//Пробелы тоже считаются в подсчете
...
//indexOf - выводит индекс первой буквы прописанной строки или буквы:
...
//trim, trimStart, trimEnd - это методы для строк, которые используються для удаления пробелов.
/*console.log('   hello'.trimStart());
console.log('hello   '.trimEnd());
console.log('  hello  '.trim());*/

//toLowerCase/toUpperCase - это методы для строк, которые используються для смены регистра символа в строке.
...
//replace -  используется для смены первой определенной подстроки 
//в исходной строке другой строки или значения
