...
//Задача 5: Вывести на экран сумму чисел от 1 до 100 включительно, не кратных 3://
...
//Задача 5: Написать функцию pow(x,y) которая будет принимать 2 числа, первое это число, которое мы будем сводить в степень, второе в которую степень.
