...
/*Напишите программу, которая будет принимать два значения, первое это единица измерения (километры, часы и килограммы), второе значение это количество, а затем переводить эти значения:
Километры в метры
часа в минуты
Килограммы в граммы
